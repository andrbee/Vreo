...
if( $_POST['paymentSurname'] && $_POST['paymentCompanyname'] && $_POST['paymentAddress'] && $_POST['paymentCountry'] && $_POST['payment'] ) {
    $metas = array(
        'paymentSurname'     => $_POST['paymentSurname'],
        'paymentCompanyname' => $_POST['paymentCompanyname'],
        'paymentAddress'     => $_POST['paymentAddress'] ,
        'paymentCountry'     => $_POST['paymentCountry'] ,
