<?php
/*
 * Template name: Place your brand
 */
...
?>
    ...
    <div class="page-content">
        ...
        <br>
        <div class="row">
            <form action="<?php echo get_stylesheet_directory_uri(). '/inc/place-step/firstStep.php'; ?>" method="post" class="place-form">
            <ul class="place-block">
            <?php
                            ...
                            ?>
                                <li class="place-list">
                                    <a class="image-popup-vertical-fit" href="<?php echo $imageUrl; ?>">
                                        <img  src="<?php echo $imageUrl; ?>" style="width: 250px; height: 170px;"/>
                                    </a>
                                    <label class="mt-checkbox mt-checkbox-outline">
                                        <input type="checkbox" name="postition[]" value="<?php echo $colPosition; ?>" checked disabled>
                                        <span></span>
                                    </label>
                                    <a class="image-popup-vertical-fit" href="<?php echo $imageUrl; ?>"><i class="fa fa-search"></i></a>
                                </li>
                            <?php
                        }
                    }
                ...
                <button type="submit" class="btn green place-form__btn">Next step</button>
            </form>
        </div>

        <!-- End first step registration advertising -->

       <!-- <form action="/place-your-brand/?idDev=<?/*=$idDevPlace;*/?>&pageId=<?/*=$postIdPlace;*/?>" method="post" enctype="multipart/form-data">
            <div class="col-md-12">
                                    ...
                                    <span class="fileinput-filename"> </span>
                                                                ...
                                                                <span class="input-group-addon btn default btn-file">
                                                                    ...
                                                                    <input type="file" id="campaign_video"
                                                                           name="placeBrandVideo" onchange="uploadFilesSize()"
