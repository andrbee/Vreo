<?php
/*
 * Template name: Place third step
 */
...
$messageAll = $wpdb->get_results("SELECT * FROM ps_message_finish WHERE id_dev = $idDevPlace AND id_post = $postIdPlace");
...
$status = $wpdb->get_results("SELECT * FROM ps_finish WHERE postIdPlace = $postIdPlace AND idDevPlace = $idDevPlace AND curIdPlace = $idCurUser AND status = 1 ORDER BY id DESC LIMIT 1");

$approveDeveloper = $wpdb->get_results("SELECT * FROM pl_step_files WHERE id_dev = $idDevPlace AND id_post = $postIdPlace");
$approvedDeveloper = $wpdb->get_results("SELECT * FROM pl_step_files WHERE id_dev = $idDevPlace AND id_post = $postIdPlace AND approve = 1 AND approve_brand = 1");
...
?>
    ...
    <div class="page-content">
        ...
        <?php require_once get_template_directory() . "/template-parts/stepThird.php"; ?>
        ...
        <div class="row">
            ...
            <div class="portlet light bordered">
                <div class="portlet-body">
                                ...
                                <?php if ($item->user_message_id != $cur_user_id) {
                                    ...
                                    <li class="in">
                                        ...
                                        <div class="message">
                                            ...
                                            <span class="datetime"> at <?php echo str_replace('-', '.',date('d-m-Y', strtotime($item->date))); ?> </span>
                    ...
                    <form
                        action="<?php echo get_stylesheet_directory_uri() . '/inc/place-step/thirdStep.php?formSet=message'; ?>"
                        method="post">
                        <div class="chat-form">
