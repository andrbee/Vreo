...
if(isset($_POST['change_username']))
{
    ...
    {
        if(!changeAdminAuthUsername($_POST['password'], purgeString($_POST['username'])))
        {
...
if(isset($_POST['change_password']))
{
    if(isset($_POST['old_password']) && isset($_POST['new_password']) && isset($_POST['new_password_again']))
    {
        ...
        {
            if(!changeAdminAuthPassword($old, $new))
            {
...
<html>
    <body>
        ...
        <form action="?" method="post" autocomplete="off">
            ...
            Username: <input type="text" name="username" value="<?php echo getAdminAuthUsername(); ?>" autocomplete="off"><br>
