...
?>
    ...
    <div class="page-content">
        ...
        <div class="header__marketplace" style="margin-bottom: 24px;position: relative;background-repeat: no-repeat;-webkit-background-size: contain;background-size: contain;height: 0;padding-bottom: 31.25%;width: 100%;height: 440px;background-image: url(<?php $upload_dir = wp_upload_dir('2017/02'); echo $upload_dir['url'] ?>/haloween.jpg);">
...
//        echo "</pre>";
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 margin-bottom-10">
                    <a href="<?=get_site_url()?>/category/<?=$categ->slug?>/" class="clearfix">
                        <div class="dashboard-stat blue">
                                <div class="visual">
                                    <img src="<?php $upload_dir = wp_upload_dir('2017/02'); echo $upload_dir['url']."/".$categ->name ?>.png" alt="">
                                </div>
                                <div class="details">
                                    <div class="number"><?=$categ->name?></div>
                                    <div class="desc"><?php echo $categ->count==0 ? "there are no campaigns" : $categ->count." campaigns count";?></div>
                                </div>
                                <a class="more" href="javascript:;"> View <?=$categ->name?> campaigns
        ...
        <div class="row"><?php foreach ($posts3 as $key){
            $cur_id = $key->post_author;
            $all_user_info = get_userdata($cur_id);
            ?>
            <div class="col-md-3">
                <div class="mt-widget-2">
                    <div class="mt-head" style="background-image: url(<?=$key->campaign_bg_header;?>);">
                        <div class="mt-head-user">
                            <div class="mt-head-user-img">
                                <img src="<?=$user_info->profilePic; ?>"> </div>
                        </div>
                    </div>
                    <div class="mt-body">
                        <h3 class="mt-body-title"> <?=$key->post_title;?> </h3>
                        <p class="mt-body-description"> <?=$key->campaign_editor_1;?> </p>
                        <ul class="mt-body-stats">
                            ...
                            if(!empty($tags)){
                                foreach($tags as $tag) {
                                    echo "<li class=\"font-green btn yellow-mint\">".$tag->name."</li>";
                                }
                            }
                            ?>
                        </ul>
        ...
        <div class="button-menu">
            <ul style="list-style: none; margin: 0;padding-left: 0;">
                <?php
                $args = array('category' => 0,'author'=>$cur_user_id,'tag'=> $_GET['hashtag']);
                //$myposts = get_posts( $args );
                if(!empty($myposts)){
                    foreach( $myposts as $post ){ setup_postdata($post);?>
                        <li style="padding-left: 20px;padding-right: 20px;padding-top: 10px;padding-bottom: 10px;border-bottom: 1px solid darkolivegreen;">
                            <div class="row">
                                <div class="col-md-3">
...
//                    echo "<h1 class=\"page-title\">On request
//                            <i style='color: brown;'>\"".$_GET['hashtag']."\" </i> &nbsp;nothing has been found
//                        </h1>";
                }
